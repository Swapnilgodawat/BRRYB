    ...
    <div class="container">
      ...
      <div class="container">
          ...
          <div class="row">
              ...
              <div class="col-md-3">
                  <p class="lead">Renter Name:Krish Parekh</p>
                  <div class="list-group">
                      <a href="checkout.php" class="list-group-item active">Pick-up</a>
                      <a href="checkout.php" class="list-group-item active">Delivery</a>
                  </div>
              </div>
              ...
              <div class="col-md-9">
                  ...
                  <div class="thumbnail">
                      ...
                      <div class="caption-full">
                          <h4 class="pull-right">Rs-200/day+500 deposit</h4>
                          <h4><a href="#">Firefox Cycle</a>
                          </h4>
